...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $.$get$MyWorkerImpl_self();
              (t1 && C.DedicatedWorkerGlobalScope_methods).addEventListener$2(t1, "message", new A.MyWorkerImpl_connect_closure(channel));
              t2 = A._lateReadCheck(A._lateReadCheck(channel.__StreamChannelController__foreign, "_foreign").__GuaranteeChannel__streamController, "_streamController");
              new A._ControllerStream(t2, B._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(new A.MyWorkerImpl_connect_closure0());
              B.print("(Worker) Sending ready event");
              C.DedicatedWorkerGlobalScope_methods.postMessage$1(t1, "ready");
              ...
              $async$goto = 2;
              return B._asyncAwait($async$self.run$2(new A._ControllerStream(t2, B._instanceType(t2)._eval$1("_ControllerStream<1>")), A._lateReadCheck(A._lateReadCheck(channel.__StreamChannelController__local, "_local").__GuaranteeChannel__sink, "_sink")), $async$connect$0);
            case 2:
              // returning from await.
              result = $async$result;
              B.print("(Worker) Finished with result: " + result);
              C.DedicatedWorkerGlobalScope_methods.postMessage$1(t1, {result: result});
              // implicit return
  ...
  A.MyWorkerImpl_connect_closure.prototype = {
    call$1($event) {
      ...
      message = A._messageFromMap(type$.Map_dynamic_dynamic._as(new B._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy($event.data, true)));
  ...
  A.MyWorkerImpl_connect_closure0.prototype = {
    call$1(message) {
      ...
      B.print("(Worker) Sending message to main: " + B.S(self.JSON.stringify(message)));
      t1 = $.$get$MyWorkerImpl_self();
      (t1 && C.DedicatedWorkerGlobalScope_methods).postMessage$1(t1, message);
    },
    $signature: 25
  };
...
$__dart_deferred_initializers__["uU8pJD/PkiTnUx9cR+ntZ3cNSCw="] = $__dart_deferred_initializers__.current
