...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var A = {nullFuture_closure: function nullFuture_closure() {
    ...
    GuaranteeChannel: function GuaranteeChannel(t0) {
      this.__GuaranteeChannel__streamController = this.__GuaranteeChannel__sink = $;
      this.$ti = t0;
    },
    ...
    _GuaranteeSink: function _GuaranteeSink(t0, t1, t2) {
      var _ = this;
      _._inner = t0;
      _._doneCompleter = t1;
  ...
  A.Stream.prototype = {
    ...
    get$first(_) {
      var future = new B._Future($.Zone__current, this.$ti._eval$1("_Future<1>")),
        ...
        t1 = subscription.$ti;
      subscription.set$_onData(A._BufferingStreamSubscription__registerDataHandler(subscription._zone, t1._eval$1("~(1)?")._as(new A.Stream_first_closure0(this, subscription, future)), t1._precomputed1));
      return future;
    }
  };
  ...
  A._BufferingStreamSubscription.prototype = {
    ...
    set$_onData(_onData) {
      this._onData = B._instanceType(this)._eval$1("~(1)")._as(_onData);
    },
      ...
      var $async$run$2 = B._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$temp1 = self.wasm_bindgen;
              $async$temp2 = type$.Uint8List;
              $async$temp3 = J;
              $async$goto = 3;
              return B._asyncAwait(listen.get$first(listen), $async$run$2);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.base64_encode_wasm($async$temp2._as($async$temp3.get$data$x($async$result)));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      var $async$connect$0 = B._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $.$get$MyWorkerImpl_self().importScripts("/wasm/native_lib.js");
              $async$goto = 2;
              return B._asyncAwait(B.promiseToFuture(self.wasm_bindgen("/wasm/native_lib_bg.wasm"), type$.void), $async$connect$0);
            case 2:
              // returning from await.
  ...
  A.GuaranteeChannel.prototype = {
    GuaranteeChannel$3$allowSinkErrors(innerSink, allowSinkErrors, _box_0, $T) {
      var _this = this,
        t1 = _this.$ti,
        t2 = t1._eval$1("_GuaranteeSink<1>")._as(new A._GuaranteeSink(innerSink, new B._AsyncCompleter(new B._Future($.Zone__current, type$._Future_dynamic), type$._AsyncCompleter_dynamic), $T._eval$1("_GuaranteeSink<0>")));
    ...
    set$_subscription(_subscription) {
      this.$ti._eval$1("StreamSubscription<1>?")._as(_subscription);
    }
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(B.Object, [A.Stream, A._StreamController, A._SyncStreamControllerDispatch, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._StreamSinkWrapper, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._WorkerBeeBase_Object_StreamChannelMixin, A.StreamChannelMixin, A._GuaranteeSink, A.StreamChannelController]);
  ...
  B._Universe_addRules(init.typeUniverse, JSON.parse('{"_StreamController":{"StreamController":["1"],"StreamSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_AsyncStreamController":{"_AsyncStreamControllerDispatch":["1"],"_StreamController":["1"],"StreamController":["1"],"StreamSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_SyncStreamController":{"_SyncStreamControllerDispatch":["1"],"_StreamController":["1"],"StreamController":["1"],"StreamSink":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"]},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"StreamSubscription":["1"],"_EventDispatch":["1"]},"_StreamSinkWrapper":{"StreamSink":["1"]},"_BufferingStreamSubscription":{"StreamSubscription":["1"],"_EventDispatch":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedError":{"_DelayedEvent":["@"]},"_DelayedDone":{"_DelayedEvent":["@"]},"_StreamImplEvents":{"_PendingEvents":["1"]},"MyWorker":{"WorkerBeeBase":["MyMessage","String"],"StreamChannel":["@"]},"MyWorkerImpl":{"WorkerBeeBase":["MyMessage","String"],"StreamChannel":["@"]},"GuaranteeChannel":{"StreamChannel":["1"]},"_GuaranteeSink":{"StreamSink":["1"]},"StreamChannelMixin":{"StreamChannel":["1"]},"WorkerBeeBase":{"StreamChannel":["@"]}}'));
  B._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"StreamChannelMixin":1}'));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "MyWorkerImpl_self", "$get$MyWorkerImpl_self", () => B.findType("DedicatedWorkerGlobalScope")._as(B._workerSelf()));
  })();
};

$__dart_deferred_initializers__["DVpkyx2JAC4l4QWpYcLmbgJllbQ="] = $__dart_deferred_initializers__.current
