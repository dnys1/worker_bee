...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    MyMessageImpl: function MyMessageImpl() {
    },
    JSON: function JSON() {
    },
    getWorkerAssignment() {
      var $async$goto = 0,
        ...
        $async$returnValue, t3, initMessage, t1, eventListener, t2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = self;
              t2.toString;
              t3 = new A.getWorkerAssignment_closure(eventListener, new A._AsyncCompleter(t1, type$._AsyncCompleter_String));
              eventListener._value = t3;
              J.addEventListener$2$x(t2, "message", t3);
              $async$goto = 3;
              return A._asyncAwait(t1, $async$getWorkerAssignment);
            case 3:
              // returning from await.
              initMessage = $async$result;
              A.print("(Worker) Got assignment: " + initMessage);
              $async$returnValue = initMessage;
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    getWorkerAssignment_closure: function getWorkerAssignment_closure(t0, t1) {
      this.eventListener = t0;
      this.initCompleter = t1;
    },
    main() {
      A.runHive($.$get$workers(), new A.main_closure());
    },
    workers_closure: function workers_closure() {
    },
      ...
      var $async$runHive = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              // then
              A.print("(Worker) Getting assignment...");
              $async$goto = 5;
              return A._asyncAwait(A.getWorkerAssignment(), $async$runHive);
            case 5:
              // returning from await.
              assignment = $async$result;
              runner = workers.$index(0, assignment);
              if (runner == null)
                throw A.wrapException(A.StateError$("No worker found for role: " + assignment));
              $async$goto = 6;
              return A._asyncAwait(runner.call$0(), $async$runHive);
            case 6:
              // returning from await.
              // goto join
              $async$goto = 3;
            ...
            case 4:
              // else
              A.print("(Main) Not a web worker. Running app...");
              $async$goto = 7;
              return A._asyncAwait(runApp.call$0(), $async$runHive);
            case 7:
              // returning from await.
            case 3:
              // join
  ...
  A.getWorkerAssignment_closure.prototype = {
    call$1($event) {
      ...
      t1 = self;
      t1.toString;
      t2 = type$.nullable_dynamic_Function_Event._as(this.eventListener._readLocal$0());
      if (t2 != null)
        J._removeEventListener$3$x(t1, "message", t2, null);
      this.initCompleter.complete$1(A._asString(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as($event).data, true)));
    },
    $signature: 7
  };
  A.workers_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.loadDeferredLibrary("example_worker"), $async$call$0);
            case 2:
              // returning from await.
              A.checkDeferredIsLoaded("example_worker");
              $async$goto = 3;
              return A._asyncAwait(C.MyWorkerImpl$().connect$0(), $async$call$0);
            case 3:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  (function inheritance() {
    ...
    _inherit(A.WorkerGlobalScope, A.EventTarget);
  ...
  var init = {
    ...
    deferredPartUris: ["worker.dart.js_1.part.js"],
    deferredPartHashes: ["DVpkyx2JAC4l4QWpYcLmbgJllbQ="],
    typeUniverse: {eC: new Map(), tR: {}, eT: {}, tPV: {}, sEA: []},
    mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"},
    mangledNames: {},
    types: ["~()", "Null(@)", "Null()", "~(@)", "~(~())", "Null(Null)", "~(Object,StackTrace)", "Null(Event)", "Future<@>(int)", "Null(List<@>)", "~(@,String,StackTrace?)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "@(@,@)", "Future<~>()", "Future<Null>()", "~(MyMessage)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","MyMessageImpl":"JavaScriptObject","JSON":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","NativeFloat32List":"NativeTypedArrayOfDouble","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"MyMessage":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[]},"JSNumNotInt":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"DeferredNotLoadedError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["double"],"List":["double"],"Iterable":["double"],"FixedLengthListMixin":["double"],"ListMixin.E":"double"},"NativeTypedArrayOfInt":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeInt16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"Uint8List":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_AsyncAwaitCompleter":{"Completer":["1"]},"AsyncError":{"Error":[]},"_Completer":{"Completer":["1"]},"_AsyncCompleter":{"_Completer":["1"],"Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetMixin":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"_SetBase":{"SetMixin":["1"],"Iterable":["1"]},"double":{"num":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MessageEvent":{"Event":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"NativeTypedArray":1,"MapBase":2,"_SetBase":1,"__SetBase_Object_SetMixin":1}'));
  var string$ = {
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_loadingLibraries", "$get$_loadingLibraries", () => A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.nullable_Future_Null));
    _lazyFinal($, "_loadedLibraries", "$get$_loadedLibraries", () => A.LinkedHashSet_LinkedHashSet(type$.String));
    _lazy($, "_cspNonce", "$get$_cspNonce", () => A._computeCspNonce());
    _lazy($, "_crossOrigin", "$get$_crossOrigin", () => A._computeCrossOrigin());
    _lazy($, "thisScript", "$get$thisScript", () => A._computeThisScript());
    _lazyFinal($, "_AsyncRun__scheduleImmediateClosure", "$get$_AsyncRun__scheduleImmediateClosure", () => A._AsyncRun__initializeScheduleImmediate());
    _lazy($, "_hasErrorStackProperty", "$get$_hasErrorStackProperty", () => new Error().stack != void 0);
    _lazyFinal($, "workers", "$get$workers", () => A.LinkedHashMap_LinkedHashMap$_literal(["example", new A.workers_closure()], type$.String, A.findType("Future<~>()")));
  })();
