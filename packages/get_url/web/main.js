...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.loadDeferredLibrary("b"), $async$main);
            case 2:
              // returning from await.
              A.checkDeferredIsLoaded("b");
              C.callMe();
              // implicit return
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Error, [A.LateError, A.TypeError, A.JsNoSuchMethodError, A.UnknownJsTypeError, A.RuntimeError, A.DeferredNotLoadedError, A.AssertionError, A._Error, A.NullThrownError, A.ArgumentError, A.UnsupportedError, A.StateError, A.ConcurrentModificationError, A.CyclicInitializationError]);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.loadDeferredLibrary_loadAndInitialize, A.loadDeferredLibrary_loadAndInitialize_closure, A.loadDeferredLibrary_closure, A._loadHunk_closure, A._loadHunk_failure, A._loadHunk_closure0, A._loadHunk_closure1, A._loadHunk_closure2, A._loadHunk_closure3, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A.Future_wait_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure]);
    ...
    _inheritMany(A.Closure2Args, [A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A.Future_wait_handleError, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure]);
  ...
  var init = {
    ...
    deferredPartUris: ["main.js_1.part.js"],
    deferredPartHashes: ["bSTQ/lWA4kWZKQdhk567qL+zcYo="],
    typeUniverse: {eC: new Map(), tR: {}, eT: {}, tPV: {}, sEA: []},
    mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"},
    mangledNames: {},
    types: ["~()", "Null(@)", "~(~())", "Null(Null)", "Null()", "Future<@>(int)", "Null(List<@>)", "~(@,String,StackTrace?)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Object,StackTrace)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)"],
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[],"Pattern":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"DeferredNotLoadedError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetMixin":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"]},"_SetBase":{"SetMixin":["1"],"Iterable":["1"]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"MapBase":2,"_SetBase":1,"__SetBase_Object_SetMixin":1}'));
  var string$ = {
